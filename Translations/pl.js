_global.translation["pl"] = {
  ...
  "1_3_1_H43.IncorrectAttrNotice":
    "Sprawdź, czy atrybut headers dla elementu td jest poprawny.",
  ...
  "1_3_1_G141_b":
    "Kolejność nagłówków nie jest poprawna. Nagłówek h{{headingNum}} powinien być oznaczony jako h{{properHeadingNum}}.",
  ...
  "1_4_3_G18_or_G145.Fail":
    "Ten element ma niewystarczający na tym poziomie zgodności stosunek kontrastu tekstu do tła. Powinien wynosić co najmniej {{required}}:1, a tekst umieszczony w tym elemencie ma stosunek {{value}}:1.",
  "1_4_3_G18_or_G145.Fail.Recomendation": "Zalecenie: ",
  "1_4_3_G18_or_G145.Fail.Recomendation.Text":
    "zmiana koloru tekstu na {{value}}",
  "1_4_3_G18_or_G145.Fail.Recomendation.Background":
    "zmiana koloru tła na {{value}}",
  ...
  "1_4_10_C32,C31,C33,C38,SCR34,G206.Check":
    "Sprawdź, czy treść może być prezentowana bez utraty informacji lub funkcjonalności oraz bez konieczności przewijania w dwóch wymiarach dla: \
  ...
  "1_4_11_G195,G207,G18,G145,G174,F78.Check":
    "Sprawdź, czy wizualna prezentacja poniższych elementów ma współczynnik kontrastu co najmniej 3:1 w stosunku do sąsiadującego koloru(ów): \
  ...
  "1_4_12_C36,C35.Check":
    "Sprawdź, czy nie nastąpi utrata treści lub funkcjonalności, ustawiając wszystkie poniższe elementy i nie zmieniając żadnej innej właściwości stylu: \
     \
  ...
  //1_4_13.js
  "1_4_13_F95.Check":
    "Sprawdź, czy w przypadku, gdy otrzymanie, a następnie usunięcie najechania wskaźnikiem lub fokusu klawiatury powoduje, że dodatkowa treść staje się widoczna, a następnie ukryta, następujące elementy są prawdziwe: \
     \
  ...
  //2_1_4.js
  "2_1_4.Check":
    "Sprawdź, czy jeśli skrót klawiaturowy jest zaimplementowany w treści przy użyciu tylko znaków literowych (w tym wielkich i małych liter), znaków interpunkcyjnych, cyfr lub symboli, to prawdziwa jest co najmniej jedna z poniższych sytuacji: \
     \
  ...
  "2_5_2.SinglePointer_Check":
    "Sprawdź, czy dla funkcji, które mogą być obsługiwane za pomocą pomocą pojedynczego wskaźnika, przynajmniej jedno z poniższych jest prawdziwe: \
  ...
  "2_5_2.Mousedown_Check":
    "Ten element nasłuchuje zdarzeń mousedown (naciśniecie wskaźnika myszy). Sprawdź, czy dla funkcji, które mogą być obsługiwane za pomocą pojedynczego wskaźnika, przynajmniej jedna z poniższych wartości jest prawdziwa: \
        Brak zdarzenia: Naciskanie nie wywołuje jakiejkolwiek części zdarzenia; \
        Przerwanie lub cofnięcie: Zdarzenie jest zależne od zwolnienia nacisku i istnieje mechanizm, którym można je przerwać lub cofnąć po zwolnieniu nacisku; \
        Up Reversal: The up-event reverses any outcome of the preceding down-event; \
        Essential: Completing the function on the down-event is essential.",
  "2_5_2.Touchstart_Check":
    "Ten element nasłuchuje zdarzeń touchstart. Sprawdź, czy dla funkcji, które mogą być obsługiwane za pomocą pojedynczego wskaźnika, przynajmniej jedna z poniższych wartości jest prawdziwa: \
     \
        Brak zdarzenia: Naciskanie nie wywołuje jakiejkolwiek części zdarzenia; \
        Przerwanie lub cofnięcie: Zdarzenie jest zależne od zwolnienia nacisku i istnieje mechanizm, którym można je przerwać lub cofnąć po zwolnieniu nacisku; \
        Odwrócenie zdarzenia: Zwolnienie nacisku cofa wywołane zdarzenie i przywraca stan sprzed zdarzenia; \
  ...
  //2_5_4.js
  "2_5_4.Check":
    "Sprawdź, czy funkcje, które mogą być obsługiwane przez ruch urządzenia lub ruch użytkownika, mogą być również obsługiwane przez elementy interfejsu użytkownika, a reagowanie na ruch może być wyłączone, aby zapobiec przypadkowemu uruchomieniu, z wyjątkiem sytuacji, gdy: \
     \
  ...
  //2_5_5.js
  "2_5_5.Check":
    "Sprawdź, czy rozmiar celu punktu dotykowego wynosi co najmniej 44 na 44 piksele CSS, z wyjątkiem sytuacji, gdy: \
     \
  ...
  "4_1_2_msg_pattern":
    "{{msgNodeType}} nie ma prawidłowej nazwy (np. atrybutu) dla API dostępności. Dopuszczalne opcje to: {{builtAttrs}}",
  ...
  "4_1_2_msg_pattern2":
    "{{msgNodeType}} nie ma wartości, która mogłaby być dostępna dla API dostępności.",
  "4_1_2_msg_add_one": "Dodaj jedną opcję do elementu.",
  "4_1_2_msg_pattern3":
    "Ten typ {{msgNodeType}} nie ma początkowo wybranej opcji. W zależności od twojej wersji HTML, wartość wystawiona na API dostępności może być niezdefiniowana.",
  "4_1_2_value_exposed_using_attribute":
    "Wartość jest eksponowana za pomocą atrybutu {{requiredValue}} attribute.",
  "4_1_2_value_exposed_using_element":
    "Wartość jest eksponowana za pomocą atrybutu {{requiredValue}} element.",
